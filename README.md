...
| Library | Model | Batch | Chunk | VRAM Usage | Time | [Accuracy Ranking](https://huggingface.co/spaces/hf-audio/open_asr_leaderboard) |
|---|---|---|---|---|---|---|
...
| [Transformers](https://github.com/huggingface/transformers) | [Whisper Large v3](https://huggingface.co/openai/whisper-large-v3) | 32 | Default | ~9.0 GB | 52.2s | #32 |
| [WhisperS2T Reborn](https://github.com/BBC-Esq/whisper-s2t-reborn) | [Whisper Large v3](https://huggingface.co/openai/whisper-large-v3) | 32 | Default | ~9.2 GB | 66.9s | #32 |
| [Faster-Whisper](https://github.com/SYSTRAN/faster-whisper) | [Whisper Large v3](https://huggingface.co/openai/whisper-large-v3) | 32 | Default | ~8.4 GB | 75.9s | #32 |
| [WhisperX](https://github.com/m-bain/whisperX) | [Whisper Large v3](https://huggingface.co/openai/whisper-large-v3) | 32 | Default | ~8.6 GB | 71.8s | #32 |
| [Granite Speech](https://github.com/ibm-granite/granite-speech) | [Granite 4.0 1B Speech](https://huggingface.co/ibm-granite/granite-speech-3.3-8b) | 8 | 30s | ~6.7 GB | 136.6s | #1 |

> VRAM includes model weights plus inference overhead.  Models were all run in bfloat16.<br>
> All parameters were chosen to achieve a maximum throughput of ~90% CUDA core usage.
